...
#ifdef PSP
	SetDirection(vfpu_atan2f(dy, dx));
#else
...
{ 
#ifdef PSP
	return vfpu_cosf(mDirection)*mSpeed;
#else
	return cosf(mDirection)*mSpeed; 
#endif  
}
...
{ 
#ifdef PSP
	return vfpu_sinf(mDirection)*mSpeed; 
#else
	return sinf(mDirection)*mSpeed; 
#endif 
}
