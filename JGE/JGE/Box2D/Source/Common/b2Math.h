...
struct b2Vec2
{
	...
	b2Vec2 operator -() { b2Vec2 v(-x, -y); return v; }
...
{
	b2Vec2 u(A.col1.x * v.x + A.col2.x * v.y, A.col1.y * v.x + A.col2.y * v.y);
	return u;
}

inline b2Vec2 b2MulT(const b2Mat22& A, const b2Vec2& v)
{
	b2Vec2 u(b2Dot(v, A.col1), b2Dot(v, A.col2));
	return u;
}

inline b2Vec2 operator + (const b2Vec2& a, const b2Vec2& b)
{
	b2Vec2 v(a.x + b.x, a.y + b.y);
	return v;
}
...
{
	b2Mat22 C(A.col1 + B.col1, A.col2 + B.col2);
	return C;
}
...
{
	b2Mat22 C(b2Mul(A, B.col1), b2Mul(A, B.col2));
	return C;
}
...
{
	b2Vec2 b(fabsf(a.x), fabsf(a.y));
	return b;
}

inline b2Mat22 b2Abs(const b2Mat22& A)
{
	b2Mat22 B(b2Abs(A.col1), b2Abs(A.col2));
	return B;
}
...
{
	b2Vec2 c(b2Min(a.x, b.x), b2Min(a.y, b.y));
	return c;
}
...
{
	b2Vec2 c(b2Max(a.x, b.x), b2Max(a.y, b.y));
	return c;
}
